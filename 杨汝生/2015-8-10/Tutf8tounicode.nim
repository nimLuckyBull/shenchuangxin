...
proc utf8tounicode(str:string):unicodeint = 
  ...
  of 2:
    ##result[0] = (int(str[0]) and 0x1C) div (2^2)
    result[0] = (int(str[0]) and 0x1C) shr 2                                            ##用移位操作代替乘除运算
    ##result[1] = (int(str[1]) and 0x3F) or ((int(str[0]) and 0x03) * (2^6))
    result[1] = (int(str[1]) and 0x3F) or ((int(str[0]) and 0x03) shl 6)
    result[6] = 1
  of 3 :
    ##result[1] = (int(str[2]) and 0x3F) or ((int(str[1]) and 0x03) * (2^6))
    result[1] = (int(str[2]) and 0x3F) or ((int(str[1]) and 0x03) shl 6)

    ##result[0] = ((int(str[0]) and 0x0F) * (2^4)) or 
                        #((int(str[1]) and 0x3C) div (2^2))
    ...
    result[6] = 1
  of 4:
    ##result[2] = (int(str[3]) and 0x3F) or ((int(str[2]) and 0x03) * (2^6))
    ##result[1] = ((int(str[2]) and 0x3C) div (2^2)) or 
                        ##((int(str[1]) and 0x0F) * (2^4))

    ##result[0] = ((int(str[1]) and 0x30) div (2^4)) or 
                       ##((int(str[0]) and 0xF7) * (2^2))
